...
class DiceGame:
    ...
    # shows the top scores of the dice game
    ...
    # this is where the actual dice game itself
    def play_game(self):
        os.system('cls')
        ...
        while True:
            ...
            if points["user"] != points["cpu"]:
                ...
                if winner == "user":
                    ...
                    # Update user points and stages won
    ...
    # logouts the user and brings back to the login window
    def logout(self):
        os.system('cls')
        print("Logging out...")
        time.sleep(1)
